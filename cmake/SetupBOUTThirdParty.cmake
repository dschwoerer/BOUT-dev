...
if (BOUT_USE_NLS)
  ...
  if (GETTEXT_FOUND)
	...
	message(FATAL_ERROR "Intl not found but requested! Set -DBOUT_USE_NLS=AUTO to ignore.")
      endif()
    endif()
  else()
    if (NOT BOUT_USE_NLS STREQUAL "AUTO")
      message(FATAL_ERROR "GETTEXT not found but requested! Set -DBOUT_USE_NLS=AUTO to ignore.")
    endif()
  endif()
endif()
